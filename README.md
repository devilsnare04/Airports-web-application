AIRPORTS
  ...
  A scala application web application using play framework that will ask the user for two actions : Query or Reports.
 ...
 The input can also be a fuzzy matching logic for partial entered country name. e.g. entering zimb will result in Zimbabwe :)
